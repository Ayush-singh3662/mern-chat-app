    ...
    <div className="flex flex-col items-center justify-center min-w-96 mx-auto">
      ...
      <form onSubmit={handleSubmit}>
        <div>
          ...
          <input type="text" placeholder="Enter your full name" className="w-full input input-ordered h-10" value={inputs.fullName} onChange={(e) => setInputs({...inputs, fullName: e.target.value})} />
        </div>
        <div>
          <label className="label p-2">
            <span className="text-base label-text">UserName</span>
          </label>
          <input type="text" placeholder="Enter your user name" className="w-full input input-ordered h-10" value={inputs.userName} onChange={(e) => setInputs({...inputs, userName: e.currentTarget.value})} />
        </div>
        <div>
            <label className="label p-2">
